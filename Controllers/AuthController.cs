    ...
    IOptions<JwtOptions> jwtOptions) : ControllerBase
{
    ...
    public async Task<ActionResult<AuthResponse>> Login(LoginRequest request)
    {
        ...
        if (user.ApprovalStatus == UserApprovalStatus.Declined)
        {
            return Unauthorized(new { message = "Your account request was declined. Contact an admin for help." });
        }
    ...
    public async Task<ActionResult<RegisterResponse>> Register(RegisterRequest request)
    {
        ...
        return Ok(new RegisterResponse("Your account request has been submitted. An admin needs to approve it before you can log in."));
    }
